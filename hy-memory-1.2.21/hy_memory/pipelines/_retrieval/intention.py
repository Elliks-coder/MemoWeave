...
async def recall_intentions(
    ...
    *,
    ...
    Args:
        ...
        limit: 召回上限
        score_threshold: 最低语义相似度，默认与 Normal 路一致为 0.4
    ...
    _now = _naive_utc(now or datetime.now())
    ...
    for h in hits:
        ...
        comparable_valid_until = _naive_utc(valid_until) if valid_until else None
        if comparable_valid_until and _now > comparable_valid_until:
