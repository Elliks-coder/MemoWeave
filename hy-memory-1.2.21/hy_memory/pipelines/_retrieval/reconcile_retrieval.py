...
class ReconcileRetrievalConfig:
    """Reconcile candidate recall configuration."""

    limit: int = 20
    vec_pool_multiplier: int = 3
    # Reconcile is a high-recall candidate stage followed by an LLM decision;
    # it should not reuse the stricter user-facing search threshold.
    min_score: float = 0.3
    w_sem: float = 0.6
    w_bm25: float = 0.4
